  ...
  <div class="box p-4 container-fluid">
    ...
    <form action="register.php" method="POST">
      <div class="row row-cols-2">
        <div class="col">
          <img src="images/signup-image.png" alt="hello" width="500" class="welcome-img">
        </div>
        ...
        <div class="col">
          ...
          <div class="d-flex align-items-center justify-content-center">
            <button name="sign-up" type="submit" class="btn btn-danger w-50 mt-3 d-inline-block">SIGN UP</button>
          </div>
